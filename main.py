...
def get_audio_and_link(request, download_limit=1000):
...
if __name__ == '__main__':
    get_audio_and_link("slovenska otroška glasba")
    get_audio_and_link("slovenske otroške")
    get_audio_and_link("slovenske mladinske pesmi")
